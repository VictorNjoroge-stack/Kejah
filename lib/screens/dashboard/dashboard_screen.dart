        ...
        child: RefreshIndicator(
          ...
          child: FutureBuilder<Dashboard>(
            ...
            builder: (context, dashboardSnapshot) {
              ...
              final dashboard = dashboardSnapshot.data ?? Dashboard.empty();
                    ...
                    child: ConstrainedBox(
                      ...
                      child: ListView(
                        padding: EdgeInsets.symmetric(
                          horizontal: DashboardBreakpoints.horizontalPadding(
                            context,
                          ),
                          vertical: 24,
                        ),
                        children: [
                          ...
                          DashboardSection(
                            ...
                            child: DashboardGrid(
                              children: [
                                StatCard(
                                  title: 'Buildings',
                                  value: dashboard.totalBuildings.toString(),
                                  icon: Icons.apartment_rounded,
                                  color: Colors.indigo,
                                ),
                                StatCard(
                                  title: 'Units',
                                  value: dashboard.totalUnits.toString(),
                                  icon: Icons.home_work_rounded,
                                  color: Colors.teal,
                                  subtitle: '${dashboard.occupiedUnits} Occupied',
                                ),
                                StatCard(
                                  title: 'Tenants',
                          ...
                          DashboardSection(
                            ...
                            child: RevenueSummaryCard(
                              collectedRevenue: dashboard.totalRevenue,
                              expectedRevenue: dashboard.expectedRevenue,
                            ),
                          ),
                          const SizedBox(height: 24),
                          DashboardSection(
                          ...
                          DashboardSection(
                            ...
                            child: MaintenanceSummaryCard(
                              openRequests: dashboard.openMaintenance,
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
